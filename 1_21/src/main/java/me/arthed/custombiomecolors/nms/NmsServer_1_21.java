...
public class NmsServer_1_21 implements NmsServer {
    ...
    private final RegistryMaterials<BiomeBase> biomeRegistry = (RegistryMaterials<BiomeBase>) ((CraftServer) Bukkit.getServer()).getServer().(Registries.ap);

    @Override
    public NmsBiome getBiomeFromBiomeKey(BiomeKey biomeKey) {
        return new NmsBiome_1_21(this.biomeRegistry.a(ResourceKey.a(Registries.ap, new MinecraftKey(biomeKey.key, biomeKey.value))));
    }

    @Override
    public NmsBiome getBiomeFromBiomeBase(Object biomeBase) {
        return new NmsBiome_1_21(((Holder<BiomeBase>) biomeBase).a());
    }
    ...
    public void loadBiome(BiomeKey biomeKey, BiomeColors biomeColors) {
        ...
        ResourceKey<BiomeBase> customBiomeKey = ResourceKey.a(Registries.ap, new MinecraftKey(biomeKey.key, biomeKey.value));
